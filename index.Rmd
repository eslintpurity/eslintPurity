...
<section>
<div class="container-fluid" id = "grid" style= "background-image: url('images/Lighthouse.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover; background-color: #ddd; margin-right: -24%; margin-left: -24%; padding-right: 24%; padding-left: 24%; padding-top: 6%; padding-bottom: 7%;">
<div class="row">
