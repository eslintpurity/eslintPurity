...
output:
  html_document:
    highlight: textmate
---
<div class="container-fluid" style = "background-image: linear-gradient(to bottom right,#fe2f3 0,#fef485 100%); background-repeat: no-repeat; background-attachment: fixed; background-size: cover; background-color:  #85929E; margin-right: -24%; margin-left: -24%; padding-right: 24%; padding-left: 24%; padding-bottom: 4%;" id ="javascript-js">
<div class = "row"> 
...
<span style = "color: red;"> ==>> </span> <span> <a href = "https://docs.google.com/forms/d/e/1FAIpQLSePs6HAZiFjcHBNhTN4lSXbQuylzx_cZPbftGQq0aoMLungTQ/viewform?usp=sf_link" style = "color: white; font-size: 10px;">[Always available]</a></span>
</div>
...
[http://www.indicina.co]

business linking**I work with diligence and alacrity with strong focus on clean service delivery; while balancing speed with quality.** Be free to view [my CV](files\doyin_elugbadebo.pdf) and [my resume](files//resume_doyin_elugbadebo.pdf) for your perusal.

<p style = "color: purple;">Please use the guide below for easy navigation; and I do hope you find the resources on this site useful.</p>
...
<div class = "text-center col-lg-3 col-md-3 mx-auto">
<h4 class="text-center" style = "color: purple;"><a href = http//www.krystallux.com>Contact</a></h4>
[![Contact](images//contact2.png)](http://dataclone.com)
</div>
...
<h4 class = "text-center" style = "font-size: 16px; color: purple;">Please dont hesitate to <button class="w3-button w3-black w3-margin-bottom" onclick="document.getElementsByTagName("a[href='https://docs.google.com/forms/d/e/1FAIpQLSePs6HAZiFjcHBNhTN4lSXbQuylzx_cZPbftGQq0aoMLungTQ/viewform?usp=sf_link']")>Hire Me</button> for your next project...</h4>
</div>
</div>
</section>
<section>
...
<a href = "#" onclick="document.getElementById('subscribeModal').style.display='block'" style = " "><button class="w3-button w3-large w3-block w3-round w3-khaki w3-ripple">Subscribe for my weekly tutorials</button></a>
...
#between another two mutually exclusive out-of-time entities. These entities came through the process of spontaneous disintegration.
#Its the Chicken and the Egg Problem! Choose one for evolvement of other species, human inclusive.

#How did he solve this? Could he be the very first programmer? Is the universe coded as a programmed magnet? is our 
#thoughts even programmed?. Lets attempt solving this conundrum challenge with our recent programming skills.
```
